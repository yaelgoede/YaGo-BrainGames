        ...
        {TABS.map((tab) => {
          ...
          return (
            <button
              ...
              className={`flex flex-1 flex-col items-center gap-0.5 py-2.5 transition-all active:scale-90 ${
                isActive
                  ? "text-gold-bright"
            ...
            >
              ...
              <span className={`text-[10px] font-semibold ${isActive ? "text-gold-bright" : ""}`}>
